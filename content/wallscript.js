...
var microBit = document.querySelector(".grid");
...
var gameOverMsg = document.querySelector(".game_over");
...
var ledSeventeen = document.querySelector(".led-17");
...
var startButton = document
  .querySelector(".start")
  .addEventListener("click", function wallPhaseOne() {
    ...
    //call next wall
    window.setTimeout(wallPhaseTwo, 500);
  });
function wallPhaseTwo() {
  ...
  //call next wall
  window.setTimeout(wallPhaseThree, 500);
}
...
function wallPhaseThree() {
  ...
  //call next wall
  window.setTimeout(wallPhaseFour, 500);
}

function wallPhaseFour() {
  if (ledThree.classList.contains("on")) {
...
function wallPhaseFive() {
  ...
  if (
    ledTwelve.classList.contains("on") &&
    ledEleven.classList.contains("on")
  ) {
    gameOverMsg.classList.add("display");
    return;
  } else {
  ...
  if (
    ledSeventeen.classList.contains("on") &&
    ledSixteen.classList.contains("on")
  ) {
    gameOverMsg.classList.add("display");
    return;
  } else {
  ...
  if (
    ledTwentyTwo.classList.contains("on") &&
    ledTwentyOne.classList.contains("on")
  ) {
    gameOverMsg.classList.add("display");
    return;
  } else {
  ...
  //call next wall
  window.setTimeout(wallPhaseSix, 500);
}

var wallPhaseSix = (function() {
  var executed = false;
  return function() {
    if (!executed) {
      executed = true;
      ...
      window.setTimeout(wallPhaseSeven, 250);
    }
  };
})();

//call next
var wallPhaseSeven = (function() {
  var executed01 = false;
  return function() {
    if (!executed01) {
      executed01 = true;
